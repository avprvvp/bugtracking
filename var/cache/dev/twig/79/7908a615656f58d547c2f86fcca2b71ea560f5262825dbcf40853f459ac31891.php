...
class __TwigTemplate_3d2ca3526bb75d350d3fc43808d3352ef977ae7b447ef2c3652d9a98dce905f6 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('ticket_delete', {'id': ticket.id}) }}\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ ticket.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "ticket/_delete_form.html.twig", "/home/user/bugtracking/templates/ticket/_delete_form.html.twig");
    }
}
