...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\EditProjectController' => 'getEditProjectControllerService',
            'App\\Controller\\NewProjectController' => 'getNewProjectControllerService',
    ...
    /**
     * Gets the public 'App\Controller\EditProjectController' shared autowired service.
     *
     * @return \App\Controller\EditProjectController
     */
    protected function getEditProjectControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/EditProjectController.php';

        $this->services['App\\Controller\\EditProjectController'] = $instance = new \App\Controller\EditProjectController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\EditProjectController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\NewProjectController' shared autowired service.
     *
     * @return \App\Controller\NewProjectController
     */
    protected function getNewProjectControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/NewProjectController.php';

        $this->services['App\\Controller\\NewProjectController'] = $instance = new \App\Controller\NewProjectController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\NewProjectController', $this));
